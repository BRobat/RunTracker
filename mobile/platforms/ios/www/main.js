...
var MapComponent = /** @class */ (function () {
    ...
    MapComponent.prototype.track = function () {
        var _this = this;
        if (navigator.geolocation) {
            ...
            navigator.geolocation.watchPosition(function (position) {
                ...
                _this.accu = position.coords.accuracy;
            });
        }
        else {
...
module.exports = __webpack_require__(/*! /Users/tohil/Documents/Angular/runTracker/src/main.ts */"./src/main.ts");
